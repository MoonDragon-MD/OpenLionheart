...
class UILayer(cocos.layer.Layer):
    ...
    def __init__(self, is_deploy=False, current_player=None):
        ...
        self.end_turn_label = cocos.text.Label(
            "End round", font_size=16, color=(255, 255, 255, 255), anchor_x='center', anchor_y='center'
        )
        ...
        self.menu_button = cocos.sprite.Sprite(
            pyglet.image.SolidColorImagePattern((100, 100, 255, 255)).create_image(143, 50)
        )
        ...
        self.menu_label = cocos.text.Label(
            "Back to the menu", font_size=12, color=(255, 255, 255, 255), anchor_x='center', anchor_y='center'
        )
...
class DeployView(cocos.layer.Layer):
    ...
    def __init__(self, controller):
        ...
        if not self.controller.advanced:
            ...
            self.ui_layer.update_text(f"{self.playerDeploy.Name} deploying")
...
class DiceLayer(cocos.layer.Layer):
    ...
    def __init__(self, controller):
        ...
        self.button_label = cocos.text.Label(
            "Pull dice", font_size=14, x=456, y=164, color=(255, 255, 255, 255), anchor_x='center', anchor_y='center'
        )
...
class VictoryLayer(cocos.layer.Layer):
    ...
    def __init__(self, controller):
        ...
        self.victory_button = cocos.sprite.Sprite(
            pyglet.image.SolidColorImagePattern((100, 100, 255, 255)).create_image(165, 50), position=(400, 200)
        )
        self.victory_button_label = cocos.text.Label(
            "Back to the menu", font_size=14, color=(255, 255, 255, 255), anchor_x='center', anchor_y='center', position=(400, 200)
        )
    ...
    def show_victory(self, winner):
        self.victory_text.element.text = f"Winner: {winner.Name}"
        self.visible = True
...
class GameView(cocos.layer.Layer):
    ...
    def update_turn(self):
        self.ui_layer.update_text(f"Turn: {self.controller.current_player.Name}")
